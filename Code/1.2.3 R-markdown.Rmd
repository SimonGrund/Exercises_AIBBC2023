...
2. Make a new R Markdown document with html output
3. Edit the document, by adding the following:
    - headers of different levels.
    - text typeset in *italic* and **bold**.
    - ordered and unordered lists.
    - a hyperlink
4. Try to Knit your document.
5. Change output to pdf and knit it again.
...
2. Make kable table with the first 10 lines of the chd_500 data set. 
